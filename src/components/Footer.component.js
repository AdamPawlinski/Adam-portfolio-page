...
import CVfile from "../resources/cv-adam-pawlinski.pdf";
import PrivacyPolicy from "../resources/Privacy Policy - adampawlinski.pdf";
    ...
    return (
      <div className="footer">
        <div className="social">
          <div>
            <a href="mailto:adam.pawlinski@gmail.com?subject=Hey, I would like to work with you...">
              <Mail className="logo" />
            </a>
          </div>
          <div>
            <a
              href="https://www.facebook.com/adam.pawlinski.14"
              target="_blank"
            >
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/adam-pawlinski/"
              target="_blank"
            >
          ...
          <div>
            <a href="https://github.com/AdamPawlinski" target="_blank">
        ...
        <a href={CVfile} target="_blank" className="logo cv">
          <CV />
          CV
        </a>
        {this.state.isShown ? (
